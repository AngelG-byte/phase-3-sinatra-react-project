...
chett = Character.create(name: "Chett", health:30, money: 100, age: 37, strength: 2, intelligence: 7, luck: 1, cunningness: 5, charisma: 5, has_invisibility_cloak: false, has_8_ball: false, has_sword: false, has_perfume: false)
alina = Character.create(name: "Alina", health:30, money: 100, age: 30, strength: 7, intelligence: 5, luck: 2, cunningness: 2, charisma: 4, has_invisibility_cloak: false, has_8_ball: false, has_sword: false, has_perfume: false)
maxim = Character.create(name: "Maxim", health:30, money: 100, age: 18, strength: 3, intelligence: 6, luck: 2, cunningness: 7, charisma: 7, has_invisibility_cloak: false, has_8_ball: false, has_sword: false, has_perfume: false)
angel = Character.create(name: "Angel", health:30, money: 100, age: 3, strength: 4, intelligence: 4, luck: 4, cunningness: 4, charisma: 4, has_invisibility_cloak: false, has_8_ball: false, has_sword: false, has_perfume: false, has_plot_armor: true)
emily = Character.create(name: "Emily", health:30, money: 100, age: 27, strength: 4, intelligence: 2, luck: 7, cunningness: 0, charisma: 7, has_invisibility_cloak: false, has_8_ball: false, has_sword: false, has_perfume: false)
puts "Chars done"
