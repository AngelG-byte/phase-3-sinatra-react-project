...
intro = Situation.create(situation: "Sleepily, with eyes half closed, you enter the elevator and take it up the second floor, just like every other day for the past 9 weeks. You figure you'll grab yourself a little treat from Divine Cafe. Maybe a coffee and an Oatmeal Creme Pie? You head for the elevator and press the lobby button...")
