...
return(
    <div>
    <section id="char-button-section">
    <button id="char-buttons" onClick={handleFetchChett} className= {charDisplay ? "show" : "hide"}>
    <img src="IMAGES/knight.png"/>
        <p>Chett</p>
    </button>
    <button id="char-buttons" onClick={handleFetchAlina} className= {charDisplay ? "show" : "hide"}>
        <img src="IMAGES/8bitgirlnobg (1).png"/>
        <p>Alina</p>
    </button>
    <button id="char-buttons" onClick={handleFetchMaxim} className= {charDisplay ? "show" : "hide"}>
    <img src="IMAGES/knight.png"/>
        <p>Maxim</p>
        </button>
    <button id="char-buttons" onClick={handleFetchAngel} className={charDisplay ? "show" : "hide"}>
        <img src="IMAGES/knight.png"/>
        <p>Angel</p>
        </button>
    <button id="char-buttons" onClick={handleFetchEmily} className= {charDisplay ? "show" : "hide"}>
        <img src="IMAGES/8bitgirlnobg (1).png"/>
        <p>Emily</p>
        </button>
    </section>
